...
def seed_data():
    ...
    try:
        ...
        camaras_por_sede = {
            ...
            "CLD": [
                ("CAVA REFRIGERADOS 1", "Refrigerada"),
                ("CAVA REFRIGERADOS 2", "Refrigerada"),
                ("CAVA REFRIGERADOS 3", "Refrigerada"),
                ("CAVA CONGELADOS 1", "Congelada"),
                ("CAVA CONGELADOS 2", "Congelada"),
                ("CONVER 1", "Congelada"),
                ("CONVER 2", "Congelada"),
...
# Tablas ya creadas al inicio del archivo (línea 23)